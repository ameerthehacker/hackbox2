export default {
  "id": "shades-of-purple",
	...
	"colors": {
		...
		//"notebook.cellBorderColor": "#fad00066",
		//"notebook.cellHoverBackground": "#fad00033",
		//"notebook.cellInsertionIndicator": "#1e1e3f",
		//"notebook.cellStatusBarItemHoverBackground": "#ffffff26",
		//"notebook.cellToolbarSeparator": "#80808059",
		//"notebook.focusedCellBackground": "#fad00066",
		//"notebook.focusedCellBorder": "#ffffff1f",
		//"notebook.focusedEditorBorder": "#1e1e3f",
		//"notebook.outputContainerBackgroundColor": "#fad00066",
